...
ADDONTITLE     = '[COLOR aqua][B]Bang Wizard[/B][/COLOR]'
BUILDERNAME    = 'Bang Wizard'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repository.Supremacy Wizard', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://github.com/hidemyassbaby/wizland/raw/master/wizmenu'
UPDATECHECK    = 0
APKFILE        = 'http://stephen-builds.uk/data/apk.txt'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'https://github.com/hidemyassbaby/wizland/raw/master/addons.txt'
ADVANCEDFILE   = 'http://'
ROMPACK        = 'http://'
EMUAPKS        = 'http://'
ADDONPACK      = 'http://'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Bang Wizard.\r\n\r\n Need Help you know were to find us '
...
NOTIFICATION   = 'https://github.com/hidemyassbaby/wizland/raw/master/notify'
