...
DefaultSplitter="|||"; 
DefaultUrl="https://github.com/hidemyassbaby/repository.bang/raw/master/message.txt"; 
class MyWindow(xbmcgui.WindowDialog): #xbmcgui.Window): ##xbmcgui.Window
	scr={}; scr['L']=0; scr['T']=0; scr['W']=1280; scr['H']=720; 
	def __init__(self,noteType='t',noteMessage='',noteImage='',L=140,T=110,W=1000,H=500,Font='font14',TxtColor='0xFFFFFFFF'):
		...
		## ### ## 
		focus=artp('button-focus_green'); nofocus=artp('button-focus_grey'); 
		...
		self.buttonDismiss=xbmcgui.ControlButton(l1,t1,w1,h1,"OK",textColor="0xFFFFFFFF",focusedColor="0xFF000000",alignment=2,focusTexture=focus,noFocusTexture=nofocus); 
		...
		for z in [self.BG,self.ImgMessage,self.TxtMessage,self.iLogo,self.buttonRemindMe,self.buttonDismiss]: 
			...
			z.setAnimations([('WindowOpen','effect=zoom delay=0 time=1000 start=0 end=100 center=640,0'),('WindowClose','effect=zoom delay=0 time=1000 start=100 end=0 center=640,720,'+str(0-(H+T+10)))]); 
